package com.app.core.include.MybatisPlus;
...
public class MysqlGenerator {
    ...
    private static String packageClass="mht";
    private static String projectName="springbootmybatisplus";
    private static String authorName="Jang";
    private static String[] table=new String[]{"t_sys_user_info"};
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir(path+"/Tempate-core/src/main/java")//输出目录
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("zhang032111")
                        .setUrl("jdbc:mysql://47.93.16.119:3306/dbmall?useUnicode=true&characterEncoding=utf8&autoReconnect=true&failOverReadOnly=false&allowMultiQueries=true")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
...
//                        .setSuperControllerClass("com.lgq.boot.base.BaseController")
                ...
                new InjectionConfig() {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        return path+"/Tempate-core/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
                    }
                }))
        ).setTemplate(
